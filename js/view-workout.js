...
function handleGlobalTick() {
    ...
    // Sicurezza: Se l'audio context viene sospeso dal sistema, tenta di riattivarlo ad ogni tick
    ...
    container.innerHTML = `
        <div class="workout-header">
            <div class="workout-header-top">
                <button id="btn-back-workout" class="back-btn" style="margin-right:0; padding:0; background:transparent; border:none; cursor:pointer; color:inherit; display:flex; align-items:center;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>
                </button>
